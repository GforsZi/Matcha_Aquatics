...
class ManageAccountController extends Controller
{
    ...
    {
        $user = User::with('created_by:usr_id,name', 'updated_by:usr_id,name', 'deleted_by:usr_id,name')->findOrFail($id)->toArray();
    ...
    {
        $user = User::select('usr_id', 'name', 'email')->findOrFail($id);
    ...
    {
        $user = User::select('usr_id', 'email')->findOrFail($id);
        try {
    ...
    {
        try {
            $user = User::select('usr_id')->findOrFail($id);
            if ($user['usr_id'] == Auth::id()) {
